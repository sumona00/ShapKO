...
def parse_args():
    ...
    parser.add_argument('--checkpoints_dir', type=str, default='../checkpoints_OGM',
    ...
    parser.add_argument('--mode', type=str, default='multimodal', help='multimodal mode (multimoda/path/rad_omic/omic/demo)')
    parser.add_argument('--model_name', type=str, default='Test1', help='Name of the model')#Test1_shapleyStable_noRecon_signLocked
    ...
    parser.add_argument('--recon', type=bool, default=False, help="Embedding reconstruction")#default True
